 ...
 * @author rohit
 */
public class LevenshteinDistancePPTest {
    
    public LevenshteinDistancePPTest() {
    }
    ...
    /**
     * Test of getmaxtargetsize method, of class LevenshteinDistancePP.
     */
    @Test
    public void testGetmaxtargetsize() {
        System.out.println("getmaxtargetsize");
        ArrayList<Paraphrase> p = null;
        LevenshteinDistancePP instance = new LevenshteinDistancePP();
        int expResult = 0;
    ...
    /**
     * Test of compute method, of class LevenshteinDistancePP.
     */
    @Test
